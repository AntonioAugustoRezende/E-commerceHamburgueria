...
/* const usuario = [
  {
    accessToken: "1231jhdljkdhfkajhfkjfh3242",
    id: 23,
    nameUser: "Gabriel",
    ...
    techs: [
      {
        id: 23,
        nameTech: "React",
        level: ["iniciante", "intermediario", "avançado"],
      },
    ],
    jobs: [
      {
...
const empresa = [
  {
    accessToken: "1231jhdljkdhfkajhfkjfh3242",
    id: 23,
    nameCompany: "Frelancer Kenzie Topzera",
    email: "frelancer@mail.com",
    avatar: "url...",
    type: "empresa",
    jobs: [
      {
        id: 23,
        nameJob: "Desenvolvedor Front End",
        description: "Fazer sites",
        devs: [
          {
            id: 23,
            nameDev: "Gabriel",
